		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#OneTimeShipment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"OneTimeShipment-display": {
								"semanticObject": "OneTimeShipment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cg.zotc.zotc",
									"url": sap.ui.require.toUrl("com/cg/zotc/zotc")
								}
							}
						}
					}
